  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Construction tool rental - Empowering individuals with easy access to construction tools from a widespread network of suppliers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction tool rental - Empowering individuals with easy access to construction tools from a widespread network of suppliers`}
            </Text>
            <Box
